    ...
    public static void main(String[] args) {
      ...
      //  arbolAVL.imprimir(arbolAVL.root);
       // arbolAVL.insert(8," 8 xxx"," 8zzz");
        ...
        contador = contador+1;
        System.out.println("CONTADORRRRRR"+contador);
        admin.insert("barco@gmail.com", "barco",contador);
        contador = contador+1;
        System.out.println("CONTADORRRRRR"+contador);
        admin.insert("casa@gmail.com","casa",contador);
        contador = contador+1;
        admin.insert("dado@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("elefante@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("foco@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("gato@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("hilo@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("isla@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("julio@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("ka@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("loco@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("mano@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("nene@gmail.com","dado",contador);
        contador = contador+1;
        admin.insert("opera@gmail.com","dado",contador);
        
        admin.imprimir();
        admin.eliminar(admin.root,"isla@gmail.com");
        admin.eliminar(admin.root,"julio@gmail.com");
        admin.eliminar(admin.root,"ka@gmail.com");
        admin.eliminar(admin.root,"dado@gmail.com");
        admin.eliminar(admin.root,"gato@gmail.com");
        admin.eliminar(admin.root,"foco@gmail.com");
        admin.eliminar(admin.root,"elefante@gmail.com");
        admin.eliminar(admin.root,"nene@gmail.com");
        admin.eliminar(admin.root,"loco@gmail.com");
        admin.eliminar(admin.root,"opera@gmail.com");
        admin.eliminar(admin.root,"barco@gmail.com");
        admin.eliminar(admin.root,"mano@gmail.com");
        admin.eliminar(admin.root,"arbol@gmail.com");
        admin.eliminar(admin.root,"casa@gmail.com");
        admin.eliminar(admin.root,"hilo@gmail.com");
        admin.log("cosa@gmail.com", "cosa");
        admin.log("arbol@gmail.com", "arbol");
        admin.log("abeja@gmail.com", "abeja");
        admin.log("aba@gmail.com", "oso");
        admin.log("gato@gmail.com", "oso");
        
      //  admin.eliminar(admin.root,"arbol@gmail.com");
      //  admin.eliminar(admin.root,"aba@gmail.com");
      //  admin.eliminar(admin.root,"abeja@gmail.com");
      //  admin.insert("suricato","suripass", contador);
      //  admin.eliminar(admin.root, "suricato");
        admin.imprimir();
