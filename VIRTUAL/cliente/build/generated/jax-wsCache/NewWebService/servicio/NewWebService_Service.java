 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://servicio/", wsdlLocation = "http://CARLOS-PC:8080/service/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://servicio/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://CARLOS-PC:8080/service/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://servicio/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio/", "NewWebServicePort"), NewWebService.class, features);
    }
